  ...
  public: {
    Tables: {
      ...
      camp_organisers: {
        ...
        Relationships: [
          {
            foreignKeyName: "camp_organisers_camp_id_fkey"
            columns: ["camp_id"]
            isOneToOne: false
      ...
      camps: {
        Row: {
          ...
          type: Database["public"]["Enums"]["camp_type"]
          updated_at: string
          user_id: string | null
        }
        Insert: {
    ...
    Functions: {
      ...
      send_emergency_alert: {
        Args: { alert_message?: string; user_lat: number; user_lng: number }
        Returns: Json
      }
      spheroid_in: {
        Args: { "": unknown }
    ...
    Enums: {
      camp_type:
        ...
        | "cardiology"
        | "diabetes"
      hospital_status: "open" | "full" | "available"
      hospital_type: "government" | "private" | "ngo"
    }
    CompositeTypes: {
      geometry_dump: {
        path: number[] | null
